...
\label{gen_inst}
	Inspired by LearningTypographic Style(italics), we started our project first focusing on learning creating one specific English character from four input letters of the same style. In the last version of our program, we use six layers in total, including two convolutional layers and four fully connected layers. 
